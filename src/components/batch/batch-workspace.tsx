...
const previewItems: BatchItem[] = samples.map(([slug, title, , price], index) => ({ id: `sample-${index}`, batch_id: "sample", filename: `${slug}.jpg`, mime: "image/jpeg", byte_size: 0, original_path: "", processed_path: null, product_data: { sku: `SAMPLE-${index + 1}`, title, description: "", titleZh: "", descriptionZh: "", category: "Sample", priceAmount: price, currency: "hkd", stockQty: 0 }, status: "review", revision: 1, source_sha256: null, output_sha256: null, approved_by: null, product_id: null, error: null, originalUrl: `/editorial/expanded/${slug}.jpg`, processedUrl: `/editorial/expanded/${slug}.jpg` }));
